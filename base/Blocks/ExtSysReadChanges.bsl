...
Функция ОбъектыВыгрузки(context_param, connection_uuid)
	...
	Inis = АвтоматическаяОперация["Inis"];
 	InisСоотв = ТранспортИнтеграции.local_helper_json_loads(Inis);
...
// BSLLS:UnusedLocalVariable-on		
		...
		Если ТипЗнч(Data) <> Тип("Соответствие") Тогда
			block_set_variable(context,
				_last_error,
				"Не удалось получить параметры подключения для блока extsys_read_changes");
