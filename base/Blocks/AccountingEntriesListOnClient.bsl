...
Функция accounting_entries_list_items(context, block_context, local_context)
	...
	Для Каждого Запись ИЗ Результат Цикл
		Попытка
			Load_ini(Запись.ini_name);
		Исключение
			Запись.ini_name = "Blockly_БухгалтерскаяСправка_read";
